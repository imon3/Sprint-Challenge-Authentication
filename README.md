...
1. What is the purpose of using _sessions_?
    - The purpose of using _sessions_ is to keep authentication information so the user doesn't have to keep entering their credentials with every request.
...
4. What are the three parts of the JSON Web Token?
    - The header, payload and signature are the three parts of a JSON web token.
